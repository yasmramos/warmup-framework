...
public class CompleteAIExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            HotReloadManager hotReloadManager = null;  // Optional for this example
    ...
    private static void exampleClassification(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Label> trainingData = new MutableDataset<>(
                new ListDataSource<>(trainingExamples, labelFactory, 
                    new SimpleDataSourceProvenance("Training Classification Data", labelFactory))
            );
            ...
            Dataset<Label> testData = new MutableDataset<>(
                new ListDataSource<>(testExamples, labelFactory,
                    new SimpleDataSourceProvenance("Test Classification Data", labelFactory))
            );
    ...
    private static void exampleRegression(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Regressor> trainingData = new MutableDataset<>(
                new ListDataSource<>(trainingExamples, regressionFactory,
                    new SimpleDataSourceProvenance("Training Regression Data", regressionFactory))
            );
            ...
            Dataset<Regressor> testData = new MutableDataset<>(
                new ListDataSource<>(testExamples, regressionFactory,
                    new SimpleDataSourceProvenance("Test Regression Data", regressionFactory))
            );
    ...
    private static void exampleAutoML(AutoMLHotReloadEngine autoML) {
        ...
        try {
            ...
            Dataset<Label> trainingData = new MutableDataset<>(
                new ListDataSource<>(trainingExamples, labelFactory,
                    new SimpleDataSourceProvenance("AutoML Training Data", labelFactory))
            );
            
            List<Example<Label>> validationExamples = createClassificationDataset(
                labelFactory, 50, 0.5
            );
            Dataset<Label> validationData = new MutableDataset<>(
                new ListDataSource<>(validationExamples, labelFactory,
                    new SimpleDataSourceProvenance("AutoML Validation Data", labelFactory))
            );
    ...
    private static void examplePersistence(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Label> trainingData = new MutableDataset<>(
                new ListDataSource<>(trainingExamples, labelFactory,
                    new SimpleDataSourceProvenance("Persistence Training Data", labelFactory))
            );
