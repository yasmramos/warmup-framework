...
class AnnotatedConstructorAnalyzer extends MethodVisitor {
    ...
    public AnnotatedConstructorAnalyzer(String className, int access, String descriptor,
