...
public class WarmupContainer implements IContainer {
    ...
    public <T> void registerNamed(String name, Class<T> type, Object instance, boolean singleton) {
        // ✅ FIX: Validate container state before registration
        if (isShutdown()) {
    ...
    public void setProperty(String key, String value) {
        // ✅ FIX: Validate container state before setting property
        if (isShutdown()) {
    ...
    public String getProperty(String key) {
        // ✅ FIX: Validate container state before accessing property
        if (isShutdown()) {
