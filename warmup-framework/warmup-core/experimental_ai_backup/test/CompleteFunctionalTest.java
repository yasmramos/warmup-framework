...
public class CompleteFunctionalTest {
    ...
    private static void testClassificationTraining(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Label> dataset = new MutableDataset<>(
                new ListDataSource<>(examples, labelFactory,
                    new SimpleDataSourceProvenance("Test Dataset", labelFactory))
            );
    ...
    private static void testClassificationPrediction(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Label> dataset = new MutableDataset<>(
                new ListDataSource<>(examples, labelFactory,
                    new SimpleDataSourceProvenance("Predictor Dataset", labelFactory))
            );
    ...
    private static void testClassificationEvaluation(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Label> trainData = new MutableDataset<>(
                new ListDataSource<>(trainExamples, labelFactory,
                    new SimpleDataSourceProvenance("Train Data", labelFactory))
            );
            Dataset<Label> testData = new MutableDataset<>(
                new ListDataSource<>(testExamples, labelFactory,
                    new SimpleDataSourceProvenance("Test Data", labelFactory))
            );
    ...
    private static void testRegressionTraining(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Regressor> dataset = new MutableDataset<>(
                new ListDataSource<>(examples, regressionFactory,
                    new SimpleDataSourceProvenance("Regression Dataset", regressionFactory))
            );
    ...
    private static void testRegressionPrediction(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Regressor> dataset = new MutableDataset<>(
                new ListDataSource<>(examples, regressionFactory,
                    new SimpleDataSourceProvenance("Reg Predictor Dataset", regressionFactory))
            );
    ...
    private static void testRegressionEvaluation(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Regressor> trainData = new MutableDataset<>(
                new ListDataSource<>(trainExamples, regressionFactory,
                    new SimpleDataSourceProvenance("Reg Train Data", regressionFactory))
            );
            Dataset<Regressor> testData = new MutableDataset<>(
                new ListDataSource<>(testExamples, regressionFactory,
                    new SimpleDataSourceProvenance("Reg Test Data", regressionFactory))
            );
    ...
    private static void testModelPersistence(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Label> dataset = new MutableDataset<>(
                new ListDataSource<>(examples, labelFactory,
                    new SimpleDataSourceProvenance("Saveable Dataset", labelFactory))
            );
    ...
    private static void testModelLoading(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            if (!modelFile.exists()) {
                ...
                Dataset<Label> dataset = new MutableDataset<>(
                    new ListDataSource<>(examples, labelFactory,
                        new SimpleDataSourceProvenance("Temp Dataset", labelFactory))
                );
    ...
    private static void testModelManagement(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Label> dataset = new MutableDataset<>(
                new ListDataSource<>(examples, labelFactory,
                    new SimpleDataSourceProvenance("Management Dataset", labelFactory))
            );
    ...
    private static void testModelCache(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Label> dataset = new MutableDataset<>(
                new ListDataSource<>(examples, labelFactory,
                    new SimpleDataSourceProvenance("Cache Dataset", labelFactory))
            );
    ...
    private static void testAutoMLClassification(AutoMLHotReloadEngine autoML) {
        ...
        try {
            ...
            Dataset<Label> trainData = new MutableDataset<>(
                new ListDataSource<>(trainExamples, labelFactory,
                    new SimpleDataSourceProvenance("AutoML Train", labelFactory))
            );
            Dataset<Label> validData = new MutableDataset<>(
                new ListDataSource<>(validExamples, labelFactory,
                    new SimpleDataSourceProvenance("AutoML Valid", labelFactory))
            );
    ...
    private static void testEndToEndWorkflow(TribuoAIIntegration aiIntegration) {
        ...
        try {
            ...
            Dataset<Label> dataset = new MutableDataset<>(
                new ListDataSource<>(examples, labelFactory,
                    new SimpleDataSourceProvenance("E2E Dataset", labelFactory))
            );
