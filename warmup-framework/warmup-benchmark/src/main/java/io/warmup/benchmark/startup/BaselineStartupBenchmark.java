...
public class BaselineStartupBenchmark {
    ...
    public void baselineContainerCreation() {
        ...
        try {
            // Registros básicos
            container.registerBean("testBean1", TestBean.class, new TestBean("Test1", 100));
            container.registerBean("testBean2", TestBean.class, new TestBean("Test2", 200));
            container.registerBean("testBean3", TestBean.class, new TestBean("Test3", 300));
    ...
    public void baselineWithBeanProcessing() {
        ...
        try {
            for (int i = 0; i < 50; i++) {
                container.registerBean("bean_" + i, TestBean.class, new TestBean("Bean" + i, i));
            }
